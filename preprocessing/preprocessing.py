...
df_grupo.to_csv(r"/home/the14th/Downloads/grupos.csv", index=False)

# TABLA ROL
df_rol = df_alumnos_BdD['nombre_rol'].drop_duplicates()
df_rol.to_csv(r"/home/the14th/Downloads/roles.csv", index=False)
...
df_materias_unique.to_csv(r"/home/the14th/Downloads/materias.csv", index=False)
...
df_profesiones_unique.to_csv(r"/home/the14th/Downloads/profesiones.csv", index=False)
###################################################################
###################################################################
...
df_localidades_unique.to_csv(r"/home/the14th/Downloads/localidades.csv", index=False)
###################################################################
###################################################################
...
df_hobbies_unique.to_csv(r"/home/the14th/Downloads/hobbies.csv", index=False)
...
df_series_unique.to_csv(r"/home/the14th/Downloads/series.csv", index=False)
...
df_musica_unique.to_csv(r"/home/the14th/Downloads/musica.csv", index=False)
...
df_alumnos_BdD.to_csv(r"/home/the14th/Downloads/alumno.csv", index=False)
###################################################################
###################################################################
