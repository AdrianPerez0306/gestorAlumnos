...
########################################################################################
trabajo_keywords = {
    "trabaja":['trabajo', 'desarrollador', 'freelance', 'seguro', 'compañía', 'docente', 'ingeniero de datos', 'pasante','comercio', 'administrativo', 'informatica', 'oficina'],
...
################    HOBBIES KEYWORDS
########################################################################################
hobbies_keywords = ["guitarra", "viajar", "videojuegos", "mangas", "anime", "cantar", "correr", "natación", "gimnasio", "voley", "fútbol", "ajedrez", "jardinería", "series", "películas", "música"]
